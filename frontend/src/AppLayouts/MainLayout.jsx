...
const MainLayout = ({ screenWidth }) => {
    ...
    // 
    return(
        <div className="Main-layout w-full h-full flex items-center justify-center bg-gray-900">
            <header className={`Portfolio-Navbar fixed top-0 z-[999] w-full h-20 flex items-center rounded-bl-4xl rounded-br-4xl text-amber-300 ${(screenWidth<=700)?"justify-center":"justify-between"}`}>
                ...
                <span className='absolute right-8 text-3xl cursor-pointer active:scale-95 sm:hidden' onClick={() => setNavbarFlag("")}><FaBars /></span>
